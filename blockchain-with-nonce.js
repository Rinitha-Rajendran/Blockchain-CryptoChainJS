...
class Block {
    ...
    // Method to perform proof of work by finding a valid nonce
    mineBlock(difficulty) {
        // Create a string with leading zeros based on the difficulty
        const target = Array(difficulty + 1).join("0");
        // Keep incrementing nonce until a hash is found that meets the target condition
...
class BlockChain {
    ...
    constructor() {
        ...
        this.difficulty = 2; // Set the mining difficulty (number of leading zeros required in hash)
    }
    ...
    addBlock(newBlock) {
        ...
        newBlock.mineBlock(this.difficulty); // Mine the new block with the specified difficulty
